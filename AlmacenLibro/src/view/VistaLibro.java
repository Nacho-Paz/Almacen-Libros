...
public class VistaLibro extends javax.swing.JFrame {
    ...
    private void personalizarComponentes() {
        ...
        this.setDefaultCloseOperation(VistaLibro.EXIT_ON_CLOSE);
        this.setTitle("Ingreso de Libro");
        this.setLocationRelativeTo(null);
        menuBarConfig();
        comboxGenero.setEditable(false);
    ...
    // Hacer que de los campos para la fecha desaparezca el texto
    ...
    private void validaciones() {
        ...
        txtDia.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (!Character.isDigit(c)) {
                    e.consume();
                    msgAdvertencia("Este campo solo permite numeros.");
                }
            }
        ...
        if (validarFecha(txtDia.getText(), txtMes.getText(), txtAnio.getText())) {
            JOptionPane.showMessageDialog(this, "Fecha válida!", "Exito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Fecha incorrecta. Corrígela.", "Exito", JOptionPane.INFORMATION_MESSAGE);
        }*/
    }
    ...
    private boolean validarFecha() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Ingrese solo números en los campos de fecha.", "Error", JOptionPane.ERROR_MESSAGE);*/
    ...
    private void initComponents() {
        ...
        setTitle("Almacen de Biblioteca");
        ...
        jLabel7.setText("Registro de Libro");
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(comboxGenero, 0, 351, Short.MAX_VALUE)))))
    ...
    private void btnAddLibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddLibroActionPerformed
        //Valido la fecha aca porque sino se ejecuta la validación antes de escribir algo y salta constantemente error
        //entonces lo que hago es reconocer el error (sí es que lo hay) al apretar el boton
        ...
        if (validacionVacio() != 1) {
            ...
            LibroController.addLibro();
            JOptionPane.showMessageDialog(this, "¡Datos guardados correctamente!", "Exito", JOptionPane.INFORMATION_MESSAGE);
